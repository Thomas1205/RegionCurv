...
COINLINK = -L ~/work/software/linprog/thirdparty/devel/coin-Cbc/lib64/ -lClp -lCoinUtils -lOsiClp -lOsi -lCbc -lCgl -lz -lbz2 -llapack -lblas
...
all: .subdirs bin $(DEBUGDIR) $(OPTDIR) bin/lpseg.opt.L64 bin/lpinpaint.debug.L64 bin/interactiveseg.opt.L64 bin/curvdenoise.debug.L64 common/lib/commonlib.debug common/lib/commonlib.opt

.subdirs: 
	cd common; make; cd -
	cd msg_passing; make; cd -
...
bin/lpseg.opt.L64 : lpseg.cc $(OPTDIR)/gpcpetter.o $(OPTDIR)/lp_segmentation.o $(OPTDIR)/extended_lp_segmentation.o $(OPTDIR)/lp_segmenter.o $(OPTDIR)/segmentation_common.o $(OPTDIR)/qpbo_segmentation.o $(OPTDIR)/curvature.o $(OPTDIR)/mesh2D.o $(OPTDIR)/grid.o $(OPTDIR)/adaptive_mesh.o $(OPTDIR)/svg.o $(OPTDIR)/draw_segmentation.o $(OPTDIR)/conversion.o $(OPTDIR)/curvature.o $(OPTDIR)/ImageIntegrator.o $(QPBO) $(GPC) common/lib/commonlib.debug msg_passing/$(OPTDIR)/factorChainDualDecomp.o msg_passing/$(OPTDIR)/factorDualOpt.o msg_passing/$(OPTDIR)/factorMPBP.o msg_passing/$(OPTDIR)/factorTRWS.o msg_passing/$(OPTDIR)/separatorChainDualDecomp.o msg_passing/$(OPTDIR)/separatorDualOpt.o msg_passing/$(OPTDIR)/sepTRWS.o
	$(LINKER) $(OPTFLAGS) $(COINLINK) $(INCLUDE) lpseg.cc $(OPTDIR)/gpcpetter.o $(OPTDIR)/qpbo_segmentation.o $(OPTDIR)/lp_segmentation.o $(OPTDIR)/adaptive_mesh.o $(OPTDIR)/extended_lp_segmentation.o $(OPTDIR)/lp_segmenter.o $(OPTDIR)/segmentation_common.o $(OPTDIR)/mesh2D.o $(OPTDIR)/grid.o $(OPTDIR)/svg.o $(OPTDIR)/draw_segmentation.o $(OPTDIR)/conversion.o $(OPTDIR)/curvature.o $(OPTDIR)/ImageIntegrator.o common/lib/commonlib.debug msg_passing/$(OPTDIR)/factorChainDualDecomp.o msg_passing/$(OPTDIR)/factorDualOpt.o msg_passing/$(OPTDIR)/factorMPBP.o msg_passing/$(OPTDIR)/factorTRWS.o msg_passing/$(OPTDIR)/separatorChainDualDecomp.o msg_passing/$(OPTDIR)/separatorDualOpt.o msg_passing/$(OPTDIR)/sepTRWS.o $(QPBO) $(GPC) -o $@
...
bin/interactiveseg.opt.L64 : interactive_seg.cc $(OPTDIR)/gpcpetter.o $(OPTDIR)/lp_segmentation.o $(OPTDIR)/segmentation_common.o $(OPTDIR)/curvature.o $(OPTDIR)/mesh2D.o $(OPTDIR)/grid.o $(OPTDIR)/svg.o $(OPTDIR)/draw_segmentation.o $(OPTDIR)/conversion.o $(OPTDIR)/curvature.o $(QPBO) $(GPC) common/lib/commonlib.debug $(OPTDIR)/extended_lp_segmentation.o $(OPTDIR)/lp_segmenter.o $(OPTDIR)/adaptive_mesh.o $(OPTDIR)/ImageIntegrator.o msg_passing/$(OPTDIR)/factorChainDualDecomp.o msg_passing/$(OPTDIR)/factorDualOpt.o msg_passing/$(OPTDIR)/factorMPBP.o msg_passing/$(OPTDIR)/factorTRWS.o msg_passing/$(OPTDIR)/separatorChainDualDecomp.o msg_passing/$(OPTDIR)/separatorDualOpt.o msg_passing/$(OPTDIR)/sepTRWS.o
	$(LINKER) $(OPTFLAGS) $(COINLINK) $(INCLUDE) interactive_seg.cc $(OPTDIR)/gpcpetter.o $(OPTDIR)/lp_segmentation.o $(OPTDIR)/adaptive_mesh.o $(OPTDIR)/grid.o $(OPTDIR)/segmentation_common.o $(OPTDIR)/mesh2D.o $(OPTDIR)/svg.o $(OPTDIR)/draw_segmentation.o $(OPTDIR)/extended_lp_segmentation.o $(OPTDIR)/lp_segmenter.o $(OPTDIR)/conversion.o $(OPTDIR)/curvature.o $(OPTDIR)/ImageIntegrator.o common/lib/commonlib.debug msg_passing/$(OPTDIR)/factorChainDualDecomp.o msg_passing/$(OPTDIR)/factorDualOpt.o msg_passing/$(OPTDIR)/factorMPBP.o msg_passing/$(OPTDIR)/factorTRWS.o msg_passing/$(OPTDIR)/separatorChainDualDecomp.o msg_passing/$(OPTDIR)/separatorDualOpt.o msg_passing/$(OPTDIR)/sepTRWS.o common/$(OPTDIR)/storage2D.o $(QPBO) $(GPC) -o $@
